		...
		<div class="video_wrapper">
			...
			<div class="single_video">
				...
				<div class="wistia_wrapper">
					...
					<div class="wistia_inner wistia_embed wistia_async_waichudc62 popover=true popoverContent=thumbnail"></div><!-- wistia_inner -->
				...
				<span class="video_title wistia_embed wistia_async_waichudc62 popover=true popoverContent=html">Lorem ipsum dolor emo enim ipsam voluptatem quia voluptas sit aspernat</span><!-- video_title -->
